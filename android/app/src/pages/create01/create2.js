...
export default function Create02({navigation}) {
  const B = props => <Text style={{fontWeight: 'bold'}}>{props.children}</Text>;
  const Pizza02 = require('../../main/assets/images/pizza2.png');
  return (
        ...
        <View
          ...
          <LinearGradient 
                ...
                <View style={{
                 ...
                 <Text onPress={()=>navigation.navigate('Create03')} style={{
                     fontWeight : '800',
                     fontSize : 18,
                     color : 'white',
                     paddingTop : 5
