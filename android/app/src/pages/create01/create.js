...
export default function Create01({navigation}) {
  const B = props => <Text style={{fontWeight: 'bold'}}>{props.children}</Text>;
  const createPizza = require('../../main/assets/images/createpizza.png');
  const Pizza01 = require('../../main/assets/images/pizza1.png');
        ...
        <View
          ...
          <LinearGradient 
                ...
                <View  style={{
                 ...
                 <Text onPress={()=>navigation.navigate('Create02')}  style={{
                   fontWeight : '800',
                   fontSize : 18,
                   color : 'white',
                   paddingTop : 5
